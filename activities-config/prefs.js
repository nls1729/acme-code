...
const COMMIT = "Commit: 88a213adba0a3ce575dada28f67ff1eff1f058dc";
...
class ActivitiesConfiguratorSettingsWidget extends Gtk.Grid {
    ...
    _init(params) {
        ...
        this._settings.set_string(Keys.ORI_TXT, ACTIVITIES);
        this.attach(new Gtk.Label({ label: ICO_INSTS, wrap: true, xalign: 0.0 }), 1,  0, 2, 1);
        this.attach(new Gtk.Label({ label: version,      wrap: true, xalign: 1.0 }), 3,  0, 5, 1);
        this.attach(new Gtk.Label({ label: SCL_ICON , wrap: true, xalign: 0.0 }), 1,  1, 2, 1);
        this.attach(new Gtk.Label({ label: HIDE_ICON, wrap: true, xalign: 0.0 }), 1,  2, 5, 1);
        this.attach(new Gtk.Label({ label: HPAD_ICON, wrap: true, xalign: 0.0 }), 1,  3, 5, 1);
        this.attach(new Gtk.Label({ label: TXT_INSTS, wrap: true, xalign: 0.0 }), 1,  4, 1, 1);
        this.attach(new Gtk.Label({ label: HIDE_TEXT, wrap: true, xalign: 0.0 }), 1,  5, 5, 1);
        this.attach(new Gtk.Label({ label: HPAD_TEXT, wrap: true, xalign: 0.0 }), 1,  6, 5, 1);
        this.attach(new Gtk.Label({ label: RMV_ACTIV, wrap: true, xalign: 0.0 }), 1,  7, 5, 1);
        this.attach(new Gtk.Label({ label: SETS_HOTC, wrap: true, xalign: 0.0 }), 1,  8, 5, 1);
        this.attach(new Gtk.Label({ label: NADA_HOTC, wrap: true, xalign: 0.0 }), 1,  9, 5, 1);
        this.attach(new Gtk.Label({ label: HIDE_PRCS, wrap: true, xalign: 0.0 }), 1, 10, 5, 1);
        this.attach(new Gtk.Label({ label: HIDE_APPI, wrap: true, xalign: 0.0 }), 1, 11, 5, 1);
        this.attach(new Gtk.Label({ label: SHOW_OVER, wrap: true, xalign: 0.0 }), 1, 15, 5, 1);
        this.attach(new Gtk.Label({ label: PAN_COLOR, wrap: true, xalign: 0.0 }), 1, 19, 5, 1);
        this.attach(new Gtk.Label({ label: TRANS_PAN, wrap: true, xalign: 0.0 }), 1, 21, 5, 1);
        this.attach(new Gtk.Label({ label: PAN_SHDOW, wrap: true, xalign: 0.0 }), 1, 22, 5, 1);
        this.attach(new Gtk.Label({ label: SHW_TRANS, wrap: true, xalign: 0.0 }), 1, 23, 5, 1);
        this.attach(new Gtk.Label({ label: SHW_VERT , wrap: true, xalign: 0.0 }), 1, 24, 5, 1);
        this.attach(new Gtk.Label({ label: SHW_BLUR , wrap: true, xalign: 0.0 }), 1, 25, 5, 1);
        this.attach(new Gtk.Label({ label: SHW_SPRED, wrap: true, xalign: 0.0 }), 1, 26, 5, 1);
        this.attach(new Gtk.Label({ label: WIN_MAXED, wrap: true, xalign: 0.0 }), 0, 27, 2, 1);
        this.attach(new Gtk.Label({ label: POSITION,  wrap: true, xalign: 0.0 }), 1, 31, 5, 1);
        this.attach(new Gtk.Label({ label: CFLTS_DET, wrap: true, xalign: 0.0 }), 1, 36, 5, 1);
        this.attach(new Gtk.Label({ label: RST_DFLTS, wrap: true, xalign: 0.0 }), 1, 38, 5, 1);
        this.attach(new Gtk.Label({ label: RME_INSTS, wrap: true, xalign: 0.0 }), 1, 40, 5, 1);
        ...
        let iconBtn = new Gtk.Button({ label: SELECT });
        ...
        let instructions = new Gtk.Label({ label: OVERR_USR, wrap: true, xalign: 0.0 });
        ...
        // Reset
        let defaultsBtn = new Gtk.Button({ label: RESET } );
        ...
        // Readme
        let readmeBtn = new Gtk.Button({ label: README } );
