...
2020-01-26 Corrected error in Donotdisturb Button Makefile.  Added disconnect
for _statusChangedSig in dndBtnGObject.js.  Failure to disconnect was  causing
tracebacks in journal.
Uploaded for review.

2020-03-27 Updated to support GS 3.36.
Uploaded for review.

2020-04-01 Updated to support GS 3.36.1.  gnome-shell-extension-prefs has been changed and
will no longer display the prefs for an extension indicated as a parameter on the command line.
Changed to use gnome-extensions tool.  Uploaded for review.

2020-06-10 I received a report that a user could not access settings in
Ubuntu 2020.4.  I found an un-needed import in prefs.js.  I removed it and
the settings were displayed properly.  The strange thing is the code that
displays the settings (org.gnome.Shell.Extensions) is different in Ubuntu
compared to Fedora for the same Gnome Shell version.  Strange as it ever
was. Uploaded for review.


zip file: 2020-06-11 13:21 7e7e64f5
